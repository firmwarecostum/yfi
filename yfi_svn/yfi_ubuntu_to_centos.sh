...
function var_www_html_c2_to_var_www_c2(){
        echo "Change /var/www/html/c2 to /var/www/c2 for" $1
        sed 's|/var/www/html/c2|/var/www/c2|g' $1 > $1.tmp;mv $1.tmp $1;
}
...
do
        ...
        var_www_html_c2_to_var_www_c2 $i
        radclient_fix $i
