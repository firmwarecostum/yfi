...
$config['freeradius']['path_to_dictionary_files']   = '/usr/share/freeradius2/';
$config['freeradius']['radclient']                  = '/usr/bin/radclient';
$config['freeradius']['main_dictionary_file']       = '/etc/raddb/dictionary';
$config['freeradius']['realms_file']                = '/etc/raddb/proxy.conf';
